...
class BaseOption(object):
    def __init__(self):
        ...
        self.parser.add_argument('--gpu_ids', type=str, default="0", 
                                 help='gpu number. If -1, use cpu')
        
        self.parser.add_argument('--data_format_input', type=str, default='tif',
                                 help="Input data extension. [tif or npy or fits]")
        ...
        self.parser.add_argument('--input_ch', type=int, default=1, 
                                 help="# of input channels for Generater")
        
        self.parser.add_argument('--target_ch', type=int, default=1, 
                                 help="# of target channels for Generater")
        
        
        self.parser.add_argument('--data_size', type=int, default=1024, 
                                 help='image size of the input and target data')
        
        self.parser.add_argument('--logscale_input', type=bool, default=False,
                                 help='use logarithmic scales to the input data sets')
        
        self.parser.add_argument('--logscale_target', type=bool, default=False, 
                                 help="use logarithmic scales to the target data sets")
        
        self.parser.add_argument('--saturation_lower_limit_input', type=float, default=-1, 
                                 help="Saturation value (lower limit) of input")
        
        self.parser.add_argument('--saturation_upper_limit_input', type=float, default=1, 
                                 help="Saturation value (upper limit) of input")
        
        self.parser.add_argument('--saturation_lower_limit_target', type=float, default=-1, 
                                 help="Saturation value (lower limit) of target")
        
        self.parser.add_argument('--saturation_upper_limit_target', type=float, default=1, 
                                 help="Saturation value (upper limit) of target")
        
        
        self.parser.add_argument('--saturation_clip_input', type=bool, default=False, 
                                 help="Saturation clip for input data")
        
        self.parser.add_argument('--saturation_clip_target', type=bool, default=False, 
                                 help="Saturation clip for target data")
        ...
        self.parser.add_argument('--n_downsample', type=int, default=4, 
                                 help='how many times you want to downsample input data in Generator')
        
        self.parser.add_argument('--n_residual', type=int, default=9, 
...
class TrainOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--input_dir_train', type=str, default='./datasets/Train/Input',
                                 help='directory path of the input files for the model training')
        
        self.parser.add_argument('--target_dir_train', type=str, default='./datasets/Train/Target', 
                                 help='directory path of the target files for the model training')
        ...
        self.parser.add_argument('--n_epochs', type=int, default=150, 
                                 help='how many epochs you want to train')
        
        self.parser.add_argument('--latest_iter', type=int, default=0, 
                                 help='Resume iteration')
        
        self.parser.add_argument('--ch_balance', type=bool, default=True, 
                                 help='Set channel balance of input and target data')
        
        # hyperparameters 
        self.parser.add_argument('--lambda_LSGAN', type=float, default=2.0, 
                                 help='weight for LSGAN loss')
        
        self.parser.add_argument('--lambda_FM', type=float, default=10.0, 
                                 help='weight for Feature Matching loss')
        
        self.parser.add_argument('--lambda_CC', type=float, default=5.0, 
                                 help='weight for CC loss')
        
        self.parser.add_argument('--ccc', type=bool, default=True, 
                                 help='using Concordance Correlation Coefficient values (False -> using Pearson CC values)')
...
class TestOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument('--input_dir_test', type=str, default='./datasets/Test/Input',
                                 help='directory path of the input files for the model test')
        #----------------------------------------------------------------------
        
        self.parser.add_argument('--is_train', type=bool, default=False,
                                 help='test flag')
        
        self.parser.add_argument('--iteration', type=int, default=-1,
                                 help='if you want to generate from input for the specific iteration')
        
        self.parser.add_argument('--no_shuffle', type=bool, default=True, 
                                 help='if you want to shuffle the order')
